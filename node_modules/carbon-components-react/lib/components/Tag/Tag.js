...
var Tag = function Tag(_ref) {
  ...
  var tagClasses = (0, _classnames.default)("".concat(prefix, "--tag"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--tag--disabled"), disabled), _defineProperty(_classNames, "".concat(prefix, "--tag--filter"), filter), _defineProperty(_classNames, "".concat(prefix, "--tag--").concat(size), size), _defineProperty(_classNames, "".concat(prefix, "--tag--").concat(type), type), _classNames));
  ...
  return filter ? /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    title: title
  }, /*#__PURE__*/_react.default.createElement(_iconsReact.Close16, null))) : /*#__PURE__*/_react.default.createElement("div", _extends({
    className: tagClasses,
    id: tagId
