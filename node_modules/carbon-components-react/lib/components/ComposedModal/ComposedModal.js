  ...
  _createClass(ComposedModal, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          other = _objectWithoutProperties(_this$props2, ["aria-label", "className", "containerClassName", "children", "danger", "preventCloseOnClickOutside", "selectorPrimaryFocus", "size"]);
...
_defineProperty(ComposedModal, "propTypes", (_defineProperty2 = {}, _defineProperty(_defineProperty2, 'aria-label', _propTypes.default.string), _defineProperty(_defineProperty2, "children", _propTypes.default.node), _defineProperty(_defineProperty2, "className", _propTypes.default.string), _defineProperty(_defineProperty2, "containerClassName", _propTypes.default.string), _defineProperty(_defineProperty2, "danger", _propTypes.default.bool), _defineProperty(_defineProperty2, "onClose", _propTypes.default.func), _defineProperty(_defineProperty2, "onKeyDown", _propTypes.default.func), _defineProperty(_defineProperty2, "open", _propTypes.default.bool), _defineProperty(_defineProperty2, "preventCloseOnClickOutside", _propTypes.default.bool), _defineProperty(_defineProperty2, "selectorPrimaryFocus", _propTypes.default.string), _defineProperty(_defineProperty2, "selectorsFloatingMenus", _propTypes.default.string), _defineProperty(_defineProperty2, "size", _propTypes.default.oneOf(['xs', 'sm', 'lg'])), _defineProperty2));
