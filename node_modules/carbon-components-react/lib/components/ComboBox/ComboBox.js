...
var ComboBox = /*#__PURE__*/function (_React$Component) {
  ...
  function ComboBox(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelectionClear", function () {
      ...
      if ((_this$textInput = _this.textInput) !== null && _this$textInput !== void 0 && _this$textInput.current) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "disabled", "id", "items", "itemToString", "itemToElement", "titleText", "helperText", "placeholder", "initialSelectedItem", "selectedItem", "ariaLabel", "translateWithId", "invalid", "invalidText", "light", "type", "size", "shouldFilterItem", "onChange", "onInputChange", "onToggleClick", "downshiftProps", "direction", "warn", "warnText"]);
      ...
      return /*#__PURE__*/_react.default.createElement(_downshift.default, _extends({}, (0, _createPropAdapter.mapDownshiftProps)(downshiftProps), {
        ...
        }))), helperText && !invalid && !warn && /*#__PURE__*/_react.default.createElement("div", {
          id: comboBoxHelperId,
