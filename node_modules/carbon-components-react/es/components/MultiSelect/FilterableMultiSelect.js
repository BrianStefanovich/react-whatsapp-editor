  ...
  function FilterableMultiSelect(props) {
        ...
        case Downshift.stateChangeTypes.keyDownSpaceButton:
          {
            ...
            if (_this.state.isOpen !== nextIsOpen) {
              _this.handleOnMenuChange(nextIsOpen);
            }
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOnInputValueChange", function (inputValue, _ref) {
      ...
      if (type === Downshift.stateChangeTypes.changeInput) {
        ...
        if (Boolean(inputValue) !== _this.state.isOpen) {
          _this.handleOnMenuChange(Boolean(inputValue));
        }
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInputFocus", function (_) {
      _this.setState({
        inputFocused: true
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleInputBlur", function (_) {
      _this.setState({
        inputFocused: false
      });
    });
