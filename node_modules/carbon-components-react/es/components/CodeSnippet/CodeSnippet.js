...
var defaultCollapsedHeightInRows = 15;
...
function CodeSnippet(_ref) {
  ...
  var className = _ref.className,
      ...
      rest = _objectWithoutProperties(_ref, ["className", "type", "children", "disabled", "feedback", "onClick", "ariaLabel", "copyLabel", "copyButtonDescription", "light", "showMoreText", "showLessText", "hideCopyButton", "wrapText"]);
  ...
  useResizeObserver({
    ...
    onResize: function onResize() {
      if (codeContentRef !== null && codeContentRef !== void 0 && codeContentRef.current && type === 'multi') {
        ...
        setShouldShowMoreLessBtn(height > defaultCollapsedHeightInRows * rowHeightInPixels);
      }
