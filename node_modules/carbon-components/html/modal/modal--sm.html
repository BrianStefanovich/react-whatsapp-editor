...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dstpmwaos7c">Show
  modal</button>

<div data-modal id="modal-dstpmwaos7c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dstpmwaos7c-label" aria-describedby="modal-dstpmwaos7c-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dstpmwaos7c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dstpmwaos7c-heading">Modal heading</p>
