...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-d4wyah06wzi">Show
  modal</button>

<div data-modal id="modal-d4wyah06wzi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-d4wyah06wzi-label" aria-describedby="modal-d4wyah06wzi-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-d4wyah06wzi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-d4wyah06wzi-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-d4wyah06wzi" class="bx--label">Text Input label</label>
        <input id="text-input-d4wyah06wzi" type="text" class="bx--text-input" placeholder="Optional placeholder text"
