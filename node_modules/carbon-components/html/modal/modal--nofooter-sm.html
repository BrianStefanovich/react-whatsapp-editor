...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zuaz6lv2be9">Show
  modal</button>

<div data-modal id="modal-zuaz6lv2be9" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zuaz6lv2be9-label" aria-describedby="modal-zuaz6lv2be9-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zuaz6lv2be9-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zuaz6lv2be9-heading">Modal heading</p>
