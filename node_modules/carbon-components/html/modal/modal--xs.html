...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ynifavyyw0k">Show
  modal</button>

<div data-modal id="modal-ynifavyyw0k" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ynifavyyw0k-label" aria-describedby="modal-ynifavyyw0k-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ynifavyyw0k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ynifavyyw0k-heading">Modal heading</p>
