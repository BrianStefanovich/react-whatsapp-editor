...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mlno9fvgk5b">Show
  modal</button>

<div data-modal id="modal-mlno9fvgk5b" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mlno9fvgk5b-label" aria-describedby="modal-mlno9fvgk5b-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mlno9fvgk5b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mlno9fvgk5b-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
