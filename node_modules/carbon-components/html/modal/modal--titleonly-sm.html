...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i4fto067wnl">Show
  modal</button>

<div data-modal id="modal-i4fto067wnl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i4fto067wnl-label" aria-describedby="modal-i4fto067wnl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i4fto067wnl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i4fto067wnl-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
