...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-78sb7px74tp">Show
  modal</button>

<div data-modal id="modal-78sb7px74tp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-78sb7px74tp-label" aria-describedby="modal-78sb7px74tp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-78sb7px74tp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-78sb7px74tp-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
