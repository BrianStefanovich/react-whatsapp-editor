...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dok9wx5wjw">Show
  modal</button>

<div data-modal id="modal-dok9wx5wjw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dok9wx5wjw-label" aria-describedby="modal-dok9wx5wjw-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dok9wx5wjw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dok9wx5wjw-heading">Modal heading</p>
