...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pd9ph3fpidb">Show
  modal</button>

<div data-modal id="modal-pd9ph3fpidb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pd9ph3fpidb-label" aria-describedby="modal-pd9ph3fpidb-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pd9ph3fpidb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pd9ph3fpidb-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
