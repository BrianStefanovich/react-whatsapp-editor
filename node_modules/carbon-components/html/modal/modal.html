...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lvcwuo09zb8">Show
  modal</button>

<div data-modal id="modal-lvcwuo09zb8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lvcwuo09zb8-label" aria-describedby="modal-lvcwuo09zb8-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lvcwuo09zb8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lvcwuo09zb8-heading">Modal heading</p>
