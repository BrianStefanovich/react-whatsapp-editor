...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ub9l6kgytr">Show
  modal</button>

<div data-modal id="modal-ub9l6kgytr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ub9l6kgytr-label" aria-describedby="modal-ub9l6kgytr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ub9l6kgytr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ub9l6kgytr-heading">Modal heading</p>
