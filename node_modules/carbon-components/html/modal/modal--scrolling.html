...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qjbmcd283e">Show
  modal</button>

<div data-modal id="modal-qjbmcd283e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qjbmcd283e-label" aria-describedby="modal-qjbmcd283e-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qjbmcd283e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qjbmcd283e-heading">Modal heading</p>
