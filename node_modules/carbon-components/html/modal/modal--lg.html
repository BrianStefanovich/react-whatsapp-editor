...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lmv0hsyvgx">Show
  modal</button>

<div data-modal id="modal-lmv0hsyvgx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lmv0hsyvgx-label" aria-describedby="modal-lmv0hsyvgx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lmv0hsyvgx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lmv0hsyvgx-heading">Modal heading</p>
